...
const array<RectF, (size_t)SpriteUnit::Count> s_tankSpriteMap
{
	// P1
	...
	RectF{ 96.0f, 384.0f, 100.0f, 387.0f },  // AMMO-Left
	RectF{ 100.0f, 384.0f, 103.0f, 388.0f }, // AMMO-Up
	RectF{ 96.0f, 388.0f, 100.0f, 391.0f },  // AMMO-Right
	RectF{ 100.0f, 388.0f, 103.0f, 392.0f }, // AMMO-Down
	RectF{ 104.0f, 384.0f, 112.0f, 392.0f }, // Env-Empty
	RectF{ 96.0f, 400.0f, 112.0f, 416.0f },  // Flag
...
SpriteUnit Tank::operator+(SpriteUnit left, int v)
{
	return SpriteUnit((unsigned char)left + v);
}
